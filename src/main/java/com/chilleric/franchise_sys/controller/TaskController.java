...
public class TaskController extends AbstractController<TaskService> {
  ...
  public ResponseEntity<CommonResponse<String>> createTask(
  ...
  public ResponseEntity<CommonResponse<ListWrapperResponse<TaskResponse>>> getTasks(
    ...
    return response(
      service.getTasks(allParams, pageSize, page, keySort, sortField),
      LanguageMessageKey.SUCCESS,
      new ArrayList<>(),
      new ArrayList<>()
    );
  ...
  public ResponseEntity<CommonResponse<String>> deleteTask(
