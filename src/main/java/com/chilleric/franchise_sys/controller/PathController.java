...
public class PathController extends AbstractController<PathService> {
        ...
        public ResponseEntity<CommonResponse<ListWrapperResponse<PathResponse>>> getPaths(
                ...
                return response(service.getPaths(allParams, keySort, page, pageSize, sortField,
        ...
        public ResponseEntity<CommonResponse<String>> addNewPath(
                ...
                return new ResponseEntity<CommonResponse<String>>(new CommonResponse<String>(true,
                                null, LanguageMessageKey.PATH_ADD_SUCCESS, HttpStatus.OK.value(),
                                result.getViewPoints().get(PathResponse.class.getSimpleName()),
                                result.getEditable().get(PathRequest.class.getSimpleName())), null,
                                HttpStatus.OK.value());
        }
