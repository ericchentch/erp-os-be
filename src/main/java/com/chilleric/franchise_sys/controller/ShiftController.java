...
public class ShiftController extends AbstractController<ShiftService> {
  ...
  public ResponseEntity<CommonResponse<String>> createShift(
  ...
  public ResponseEntity<CommonResponse<ListWrapperResponse<ShiftResponse>>> getShifts(
    ...
    validateToken(request);
    return response(
      service.getShifts(allParams, keySort, page, pageSize, sortField),
      LanguageMessageKey.SUCCESS,
      new ArrayList<>(),
      new ArrayList<>()
    );
  ...
  public ResponseEntity<CommonResponse<ShiftResponse>> getShiftById(
    @RequestParam String shiftId,
    HttpServletRequest request
  ) {
    validateToken(request);
    return response(
      service.getShiftById(shiftId),
      LanguageMessageKey.SUCCESS,
      new ArrayList<>(),
      new ArrayList<>()
    );
  ...
  public ResponseEntity<CommonResponse<ShiftResponse>> searchShiftByName(
    ...
    validateToken(request);
    return response(
      service.searchShiftByName(shiftName),
      LanguageMessageKey.SUCCESS,
      new ArrayList<>(),
      new ArrayList<>()
    );
  ...
  public ResponseEntity<CommonResponse<String>> updateShift(
    @RequestParam String shiftId,
    @RequestBody ShiftRequest shiftRequest,
    HttpServletRequest request
  ) {
  ...
  public ResponseEntity<CommonResponse<String>> deleteShift(
    @RequestParam String shiftId,
    ...
    return new ResponseEntity<CommonResponse<String>>(
      new CommonResponse<String>(
        true,
        null,
        LanguageMessageKey.SHIFT_DELETE_SUCCESS,
        HttpStatus.OK.value(),
        new ArrayList<>(),
        new ArrayList<>()
      ),
