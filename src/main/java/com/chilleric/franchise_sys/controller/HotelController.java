...
public class HotelController extends AbstractController<HotelService> {
  ...
  public ResponseEntity<CommonResponse<String>> createHotel(
    @RequestBody(required = true) HotelRequest hotelRequest,
    HttpServletRequest request
  ) {
    ...
    return new ResponseEntity<CommonResponse<String>>(
      new CommonResponse<String>(
        true,
        null,
        LanguageMessageKey.HOTEL_ADD_SUCCESS,
        HttpStatus.OK.value(),
  ...
  public ResponseEntity<CommonResponse<String>> updateHotel(
    ...
    return new ResponseEntity<CommonResponse<String>>(
      new CommonResponse<String>(
        true,
        null,
        LanguageMessageKey.HOTEL_UPDATE_SUCCESS,
        HttpStatus.OK.value(),
        new ArrayList<>(),
        new ArrayList<>()
      ),
  ...
  public ResponseEntity<CommonResponse<String>> deleteHotel(
    @RequestParam String hotelId,
    HttpServletRequest httpServletRequest
  ) {
    validateToken(httpServletRequest);
    ...
    return new ResponseEntity<CommonResponse<String>>(
      new CommonResponse<String>(
        true,
        null,
        LanguageMessageKey.HOTEL_DELETE_SUCCESS,
        HttpStatus.OK.value(),
        new ArrayList<>(),
        new ArrayList<>()
      ),
