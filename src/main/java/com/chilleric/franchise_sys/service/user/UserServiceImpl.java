...
public class UserServiceImpl
  ...
  public void createNewUser(UserRequest userRequest, String loginId, boolean isServer) {
    ...
    repository
      .getEntityByAttribute(userRequest.getUsername(), "username")
      .ifPresent(
        thisName -> {
  ...
  public void updateUserById(
    ...
    Map<String, String> error = generateError(UserRequest.class);
    repository
      .getEntityByAttribute(userRequest.getEmail(), "email")
      .ifPresent(
        thisEmail -> {
    ...
    repository
      .getEntityByAttribute(userRequest.getPhone(), "phone")
      .ifPresent(
        thisPhone -> {
  ...
  @Override
  public Optional<ListWrapperResponse<UserResponse>> getYourUsers(
    ...
    List<User> users = repository
      .getListOrEntity(allParams, "", page, pageSize, sortField)
      .get();
    return Optional.of(
      new ListWrapperResponse<UserResponse>(
        users
          .stream()
          .map(
            user ->
  ...
  @Override
  public Optional<ListWrapperResponse<UserResponse>> getAllUsers(
    Map<String, String> allParams,
    String keySort,
    int page,
    int pageSize,
  ...
  public Optional<PusherResponse> getYourPusher(String userId) {
    ...
    return Optional.of(
      new PusherResponse(
        user.getNotificationId().toString(),
        user.getChannelId(),
