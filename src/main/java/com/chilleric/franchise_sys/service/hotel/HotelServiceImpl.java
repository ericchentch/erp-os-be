...
public class HotelServiceImpl
  extends AbstractService<HotelRepository>
  ...
  public void createNewHotel(HotelRequest hotelRequest) {
    ...
    Hotel hotel = new Hotel(
      ...
      hotelRequest.getBillDeposit(),
      hotelRequest.getVAT(),
      hotelRequest.getMaxRefund(),
      hotelRequest.getMaxDaysRefund(),
      hotelRequest.getMaxWorkHours(),
      hotelRequest.getMaxShift(),
  ...
  public void updateHotel(String hotelId, HotelRequest hotelRequest) {
    ...
    List<Hotel> hotels = repository
      .getListOrEntity(Map.ofEntries(Map.entry("_id", hotelId)), "", 0, 0, "")
      .get();
    if (hotels.size() == 0) {
      ...
      new HotelResponse(
        ...
        hotel
          ...
          .map(
            clientInformation ->
              new ClientRequest(
                clientInformation.getAddress(),
                clientInformation.getPhone()
              )
          )
          .collect(Collectors.toList()),
        hotel.getBillDeposit(),
        hotel.getVAT(),
        hotel.getMaxRefund(),
        hotel.getMaxDaysRefund(),
        hotel.getMaxWorkHours(),
        hotel.getMaxShift(),
