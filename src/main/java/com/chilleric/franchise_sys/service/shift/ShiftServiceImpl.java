...
public class ShiftServiceImpl extends AbstractService<ShiftRepository> implements ShiftService {
  ...
  public void createShift(ShiftRequest shiftRequest) {
    ...
    shift.setStartTime(DateFormat.convertStringToDate(
        DateFormat.combineDateAndHour(shiftRequest.getStartDate(), shiftRequest.getStartHour()),
        DateTime.YYYY_MM_DD_HH_MM_SS_HYPHEN));
    shift.setEndTime(DateFormat.convertStringToDate(
