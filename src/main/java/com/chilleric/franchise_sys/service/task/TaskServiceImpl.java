...
import com.chilleric.franchise_sys.repository.informationRepository.task.Task;
import com.chilleric.franchise_sys.repository.informationRepository.task.TaskRepository;
        ...
        Task task =
                new Task(new ObjectId(), new ObjectId(taskRequest.getEmployeeId()),
                        ...
                        DateFormat.convertStringToDate(
                                DateFormat.combineDateAndHour(taskRequest.getStartDate(),
                                        taskRequest.getStartHour()),
                                DateTime.YYYY_MM_DD_HH_MM_SS_HYPHEN),
                        taskRequest.getTitle(), taskRequest.getDescription(),
